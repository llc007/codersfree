    ...
    <section class="bg-gray-700 py-12 mb-12">
        <div class="container grid grid-cols-1 gap-6 lg:grid-cols-2">
            ...
            <div class="text-white">
                ...
                <p class="mb-2"><i class="fas fa-chart-line mr-1"></i>Nivel: {{$course->level->name}}</p>
                <p class="mb-2"><i class="fas fa-chart-line mr-1"></i>Categoria: {{$course->category->name}}</p>
                <p class="mb-2"><i class="fas fa-users mr-1"></i>Matriculados: {{$course->students_count}}</p>
                <p class="mb-2"><i class="far fa-star mr-1"></i>Calificacion: {{$course->rating}}</p>
